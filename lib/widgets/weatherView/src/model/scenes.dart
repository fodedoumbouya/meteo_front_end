...
Widget getWeatherScene(WeatherScene weatherScene) {
  switch (weatherScene) {
    case WeatherScene.weatherEvery:
      return WrapperScene(
        sizeCanvas: const Size(350.0, 540.0),
        isLeftCornerGradient: true,
        colors: [
          const Color(0xff1976d2).withOpacity(opacity),
          const Color(0xffe1f5fe).withOpacity(opacity),
        ],
        children: const [
          SunWidget(
            sunConfig: SunConfig(
    ...
    case WeatherScene.scorchingSun:
      return WrapperScene(
        ...
        colors: [
          const Color(0xffd50000).withOpacity(opacity),
          const Color(0xffffd54f).withOpacity(opacity),
        ],
        children: const [
          SunWidget(
            sunConfig: SunConfig(
    ...
    case WeatherScene.sunset:
      return WrapperScene(
        ...
        isLeftCornerGradient: true,
        colors: [
          const Color(0xff283593).withOpacity(opacity),
          const Color(0xffff8a65).withOpacity(opacity),
        ],
        children: const [
          SunWidget(
            sunConfig: SunConfig(
    ...
    case WeatherScene.frosty:
      return WrapperScene(
        ...
        isLeftCornerGradient: true,
        colors: [
          const Color(0xff303f9f).withOpacity(opacity),
          const Color(0xff1e88e5).withOpacity(opacity),
          const Color(0xffbdbdbd).withOpacity(opacity),
        ],
        children: const [
          SunWidget(
            sunConfig: SunConfig(
    ...
    case WeatherScene.snowfall:
      return WrapperScene(
        ...
        isLeftCornerGradient: true,
        colors: [
          const Color(0xff3949ab).withOpacity(opacity),
          const Color(0xff90caf9).withOpacity(opacity),
          const Color(0xffd6d6d6).withOpacity(opacity),
        ],
        children: const [
          SnowWidget(
            snowConfig: SnowConfig(
    ...
    case WeatherScene.showerSleet:
      return WrapperScene(
        ...
        colors: [
          ...
          const Color(0xff546e7a).withOpacity(opacity),
          const Color(0xffbdbdbd).withOpacity(opacity),
    ...
    case WeatherScene.stormy:
      return WrapperScene(
        ...
        isLeftCornerGradient: false,
        colors: [
          const Color(0xff263238).withOpacity(opacity),
          const Color(0xff78909c).withOpacity(opacity),
        ],
        children: const [
          WindWidget(
    ...
    case WeatherScene.rainyOvercast:
      return WrapperScene(
        ...
        isLeftCornerGradient: true,
        colors: [
          const Color(0xff424242).withOpacity(opacity),
          const Color(0xffcfd8dc).withOpacity(opacity),
        ],
        children: const [
          RainWidget(
            rainConfig: RainConfig(
